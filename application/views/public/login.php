                     ...
                     <div class="col-lg-6 col-md-6 mb-4">
                        <div class="login-area">
                           <div class="tab-content">
                              ...
                              <a class="btn btn-primary btnhover m-r5 button-lg radius-no" href="<?php echo base_url();?>signup">CREATE AN ACCOUNT</a>
                           </div>
                        </div>
                     </div>
                     <div class="col-lg-6 col-md-6 mb-4">
                        <div class="login-area">
                           <div class="tab-content nav">
                              <form action="<?php echo base_url('login/login'); ?>" method="post" id="login" class="tab-pane active col-12">
