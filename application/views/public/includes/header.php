            ...
            <div class="header-info-bar">
               <div class="container clearfix">
                  ...
                  <div class="logo-header logo-dark">
                     <a href="<?php echo base_url(); ?>home"><img src="<?php echo base_url(); ?>public/images/logo.jpeg" alt="logo"></a>
                  </div>
                  <!-- EXTRA NAV -->
                  <div class="extra-nav">
                     <div class="extra-cell">
                        <ul class="navbar-nav header-right">
                           <li class="nav-item">
                              <a class="TopAdd" href="#">
                              <i class="flaticon-phone"></i> 123456789
                              </a>
                           </li>
                           <li class="nav-item">
                              <a class="TopAdd" href="#">
            ...
            <div class="sticky-header main-bar-wraper navbar-expand-lg">
               <div class="main-bar clearfix">
                  <div class="container clearfix">
                     ...
                     <div class="extra-nav">
                        <div class="extra-cell">
                           <a href="<?php echo base_url(); ?>contact" class="btn btn-primary btnhover btContact">Get In Touch</a>	
                        </div>
                     </div>
                     <!-- Main Nav -->
